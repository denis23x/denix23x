	...
	return (
		<div className={"flex flex-1 flex-col gap-4 p-4 pt-0"}>
			...
			<p className={"leading-7"}>
				...
				landscapes, cultures, and moments that have inspired me. Each image tells a story, from serene natural vistas to
				vibrant city scenes, inviting you to experience the world through my lens.
			</p>
			<Separator />
		</div>
	);
