...
| ------ | ------ |
| :white_check_mark: Always Up-to-Date | :x: Performance Concerns |
| :white_check_mark: Reduced Manual Work | :x: Load on Database |
| :white_check_mark: Scalable Solution | :x: Complexity |
| :white_check_mark: Flexibility in Data Inclusion | :x: SEO Impact If Slow or Unavailable |
...
Did you know that you can split sitemaps and have as many as you'd like? :scream:

You can use your main `sitemap.xml` as an index file and add references to other parts of your site.

One of these could be your new endpoint, which will use the code I shared with you above :wink:
...
[@preview](https://octopus.do/sitemap/resource/generator)
