import MaterialsLayout from "@/components/dashboard/materials/materials-layout";
...
export const metadata = {
	...
	description: 'How to implement SVG sprite icons on Frontend project for optimized web performance. SVG sprites for reducing file requests, optimizing page load speed for modern web applications'
}
