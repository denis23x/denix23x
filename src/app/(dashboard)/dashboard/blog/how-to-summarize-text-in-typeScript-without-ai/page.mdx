import { navMainBlogHowToSummarizeTextInTypeScriptWithoutAI } from "@/stores/nav-main.store";
...
export const metadata = {
	title: navMainBlogHowToSummarizeTextInTypeScriptWithoutAI.title,
	description: navMainBlogHowToSummarizeTextInTypeScriptWithoutAI.description
}
