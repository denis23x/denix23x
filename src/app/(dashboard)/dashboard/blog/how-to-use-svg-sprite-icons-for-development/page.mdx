import { navMainBlogHowToUseSvgSpriteIconsForDevelopment } from "@/stores/nav-main.store";
...
export const metadata = {
	title: navMainBlogHowToUseSvgSpriteIconsForDevelopment.title,
	description: navMainBlogHowToUseSvgSpriteIconsForDevelopment.description
}
