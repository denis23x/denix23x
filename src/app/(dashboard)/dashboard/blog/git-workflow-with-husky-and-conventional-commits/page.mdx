import { navMainBlogGitWorkflowWithHuskyAndConventionalCommits } from "@/stores/nav-main.store";
import BlogLayout from "@/components/dashboard/blog/blog-layout";
...
export const metadata = {
	title: navMainBlogGitWorkflowWithHuskyAndConventionalCommits.title,
	description: navMainBlogGitWorkflowWithHuskyAndConventionalCommits.description
}
