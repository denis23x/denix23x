import { navMainBlogHowToCreateDynamicSitemapForSEO } from "@/stores/nav-main.store";
...
export const metadata = {
	title: navMainBlogHowToCreateDynamicSitemapForSEO.title,
	description: navMainBlogHowToCreateDynamicSitemapForSEO.description
}
