import { navMainBlogHowToMakeStorageUrlsSEOFriendly } from "@/stores/nav-main.store";
...
export const metadata = {
	title: navMainBlogHowToMakeStorageUrlsSEOFriendly.title,
	description: navMainBlogHowToMakeStorageUrlsSEOFriendly.description
}
