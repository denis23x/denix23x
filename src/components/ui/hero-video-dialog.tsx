		...
		<div className={cn("relative", className)}>
			<div className="relative cursor-pointer group" onClick={() => setIsVideoOpen(true)}>
				<Image
					...
					width={1920}
					height={1080}
					className="w-full h-full max-h-40 object-cover object-top transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border border-input"
				/>
				...
				{isVideoOpen && (
					...
					>
						...
						>
							...
							<div className="size-full border-2 border-input rounded-2xl overflow-hidden isolate z-[1] relative">
								<iframe
									src={videoSrc}
